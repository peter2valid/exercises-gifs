...
.shadow-\[0_2px_10px_rgb\(0\2c 0\2c 0\2c 0\.02\)\] {
  --tw-shadow: 0 2px 10px rgb(0,0,0,0.02);
  --tw-shadow-colored: 0 2px 10px var(--tw-shadow-color);
  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
}
.shadow-\[inset_0_4px_10px_rgb\(249\2c 115\2c 22\2c 0\.05\)\] {
  --tw-shadow: inset 0 4px 10px rgb(249,115,22,0.05);
...
.group\/input:focus-within .group-focus-within\/input\:text-blue-600 {
  --tw-text-opacity: 1;
  color: rgb(37 99 235 / var(--tw-text-opacity, 1));
}
